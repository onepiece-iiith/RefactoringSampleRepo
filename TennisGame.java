public class TennisGame1 implements TennisGame {
    ...
    public String getScore() {
        return new ScoreCalculator(m_score1, m_score2).getScore();
    }
    ...
    private class ScoreCalculator {
        ...
        public String getScore() {
            if (m_score1 == m_score2) return getEqualScore();
            if (m_score1 >= 4 || m_score2 >= 4) return getOverFourScore();
        ...
        private String getStandardScore() {
            ...
            for (int i = 1; i < 3; i++) {
                ...
                score += getScoreForTempScore(tempScore);
            }
            return score;
        }

        private String getScoreForTempScore(int tempScore) {
            String score = "";
            switch (tempScore) {
                case 0:
                    score += "Love";
